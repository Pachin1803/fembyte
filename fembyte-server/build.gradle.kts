...
paperweight {
    ...
    val fembyte = forks.register("fembyte") {
        upstream.patchDir("paperServer") {
            upstreamPath = "paper-server"
            excludes = setOf("src/minecraft", "patches", "build.gradle.kts")
            patchesDir = rootDirectory.dir("fembyte-server/paper-patches")
...
dependencies {
    implementation(project(":fembyte-api")) // fembyte
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "fembyte",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "fembyte",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Aidan",
            "Brand-Id" to "fembyte:fembyte",
            "Brand-Name" to "fembyte",
